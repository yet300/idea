...
import com.ideaapp.shared.compose.ui.screens.note.main.components.Search

import com.ideaapp.utils.BiometricPromptManager
import ideasapp.shared.generated.resources.Res
import ideasapp.shared.generated.resources.app_name
            ...
            when (result) {
                ...
                is BiometricPromptManager.BiometricResult.AuthenticationNotSet -> {
                    if (Build.VERSION.SDK_INT >= 30) {
                        ...
                        showToastMessage(activity.getString(Res.string.auth_not_set))
                    }
                }
                ...
                BiometricPromptManager.BiometricResult.AuthenticationFailed -> {
                    showToastMessage(activity.getString(Res.string.auth_faild))
                }

                BiometricPromptManager.BiometricResult.FeatureUnavailable -> {
                    showToastMessage(activity.getString(Res.string.auth_unavailable))
                }

                BiometricPromptManager.BiometricResult.HardwareUnavailable -> {
                    showToastMessage(activity.getString(Res.string.auth_hardware_unavailable))
                }
            }
        }
    }
            ...
            TrailingItem(
                ...
                secureOnClick = {
                    promptManager.showBiometricPrompt(
                        title = activity.getString(Res.string.app_name),
                    )
                },
            )
        }
